...
# app.include_router(fidelidade_expandida.router, prefix="/api/fidelidade", tags=["Fidelidade Expandida"])  # COMENTADO - NÃO IMPORTADO
# app.include_router(permissoes_expandido.router, prefix="/api/permissoes", tags=["Permissões e Roles"])  # COMENTADO - NÃO IMPORTADO
# app.include_router(comunicacao_expandido.router, prefix="/api/comunicacao", tags=["Comunicação e Notificações"])  # COMENTADO - NÃO IMPORTADO
# app.include_router(relatorios_avancados.router, prefix="/api/relatorios-avancados", tags=["Relatórios Avançados"])  # COMENTADO - NÃO IMPORTADO
...
# app.include_router(categorias_clientes.router)  # COMENTADO - NÃO IMPORTADO
# app.include_router(pesquisa_satisfacao.router)  # COMENTADO - NÃO IMPORTADO
# app.include_router(fidelidade.router)  # COMENTADO - NÃO IMPORTADO
# app.include_router(automacao.router)  # COMENTADO - NÃO IMPORTADO
# app.include_router(business_intelligence.router)  # COMENTADO - NÃO IMPORTADO
# app.include_router(analytics.router, prefix="/api/analytics", tags=["Analytics"])  # COMENTADO - NÃO IMPORTADO
# app.include_router(integracoes.router)  # COMENTADO - NÃO IMPORTADO
# app.include_router(solucoes_online.router)  # COMENTADO - NÃO IMPORTADO
# app.include_router(tickets.router)  # COMENTADO - NÃO IMPORTADO
# app.include_router(colaboradores.router)  # COMENTADO - NÃO IMPORTADO
# app.include_router(permissoes.router)  # COMENTADO - SCHEMA FALTANDO
# app.include_router(kds.router, prefix="/api/kds")  # COMENTADO - NÃO IMPORTADO
# app.include_router(mesas.router, prefix="/api/mesas")  # COMENTADO - NÃO IMPORTADO
# app.include_router(multi_cardapio.router)  # COMENTADO - DUPLICAÇÃO DE TABELA
# app.include_router(impressoras.router)  # Sistema de impressoras - COMENTADO - NÃO IMPORTADO
