...
from ..models import Usuario, Checkin, Evento, Produto, Venda
# Temporariamente desabilitado - conflito de modelos
# from ..models_meep_complete import ItemVenda, Comanda, Pedido, TransacaoCashless
...
@router.get("/general")  # response_model=DashboardStats temporariamente removido
