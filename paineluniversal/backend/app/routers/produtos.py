    ...
    try:
        ...
        for produto in produtos:
            produtos_dict.append({
                ...
                "tipo": produto.tipo_usuario.value if produto.tipo_usuario else None,
...
async def criar_produto(
    ...
    try:
        ...
        print(f"🔍 DEBUG PRODUTOS ROUTER - Dados recebidos: {produto.model_dump()}")
        logger.info(f"Dados recebidos no create: {produto.model_dump()}")
        
        # Verificar se o campo tipo está presente
        produto_dict_original = produto.model_dump()
