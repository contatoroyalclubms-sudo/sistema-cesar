...
## ⚠️ AVISO CRÍTICO - PROIBIDO LOGIN DO GOOGLE ⚠️

### NUNCA ADICIONAR GOOGLE OAUTH - ISSO QUEBRA O SISTEMA!

**PROIBIÇÕES ABSOLUTAS**:
- ❌ **NUNCA** adicionar Google OAuth
- ❌ **NUNCA** adicionar botão "Login com Google"
- ❌ **NUNCA** importar GoogleLogin, react-google-login ou qualquer biblioteca OAuth
- ❌ **NUNCA** sugerir autenticação com Google, Facebook, GitHub ou qualquer OAuth
- ❌ **NUNCA** modificar o LoginFormFixed.tsx para adicionar OAuth

**OBRIGATÓRIO**:
- ✅ **SEMPRE** usar APENAS login com CPF brasileiro
- ✅ **SEMPRE** manter o sistema com CPF + senha
- ✅ **SEMPRE** usar LoginFormFixed.tsx sem modificações
- ✅ **SE APARECER** qualquer referência a Google Login, REMOVER IMEDIATAMENTE

**O SISTEMA USA EXCLUSIVAMENTE CPF + SENHA - NÃO ALTERAR ISSO!**
